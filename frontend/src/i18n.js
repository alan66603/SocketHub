...
const resources = {
  zh: {
    translation: {
      ...
      // New features
      zoom_hint: "請放大地圖以查看咖啡廳 🔍",
      no_results: "找不到相關結果",
      loading_cafes: "正在載入咖啡廳資料...",
      filter_title: "篩選與排序",
      min_wifi: "最低 WiFi",
      any: "任意",
      filter_outlet: "插座",
      filter_time_limit: "限時",
      sort_by: "排序",
      sort_default: "預設",
      sort_wifi: "WiFi ↓",
      sort_distance: "距離 ↑",
      filter_reset: "重置",
      filter_active: "{{count}} 個篩選",
    },
  },
  en: {
    translation: {
      ...
      // New features
      zoom_hint: "Zoom in to see cafes 🔍",
      no_results: "No results found",
      loading_cafes: "Loading cafes...",
      filter_title: "Filter & Sort",
      min_wifi: "Min WiFi",
      any: "Any",
      filter_outlet: "Outlets",
      filter_time_limit: "Time Limit",
      sort_by: "Sort By",
      sort_default: "Default",
      sort_wifi: "WiFi ↓",
      sort_distance: "Distance ↑",
      filter_reset: "Reset",
      filter_active: "{{count}} active",
    },
  },
};
