...
const timeLimitMap = { limited: "有限時", unlimited: "不限時", unknown: "未知" };
        ...
        <div className="p-6 flex-1 overflow-y-auto">
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-gray-50 p-3 rounded-lg text-center">
                    ...
                    <div className="text-xl font-bold text-blue-600">{cafe.ratings.wifiStability || '-'} <span className="text-sm text-gray-400">/ 5</span></div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg text-center">
                    <div className="text-xs text-gray-500 mb-1">插座</div>
                    <div className="text-lg font-bold text-gray-700">{socketMap[cafe.features.hasManySockets] || '-'}</div>
                </div>
                <div className="bg-gray-50 p-3 rounded-lg text-center">
                    <div className="text-xs text-gray-500 mb-1">限時</div>
                    <div className="text-lg font-bold text-gray-700">{timeLimitMap[cafe.features.timeLimit] || '-'}</div>
                </div>
            </div>
            ...
            <div>
                <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                    💬 評論 
                    <span className="text-sm font-normal text-gray-500">({cafe.comments?.length || 0})</span>
                </h3>
